...
an annotation tool forcreating high-quality datasets using active and proactive learning based on brat and NeuroNER

- [brat](https://github.com/nlplab/brat) rapid annotation tool
- [NeuroNER](https://github.com/Franck-Dernoncourt/NeuroNER) is a program that performs named-entity recognition (NER). Website: [neuroner.com](http://neuroner.com).
